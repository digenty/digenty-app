...
public class StudentService {
    ...
    public ClassRoom createProduct(CreateProductDto createProductDto) {
    ...
    public ProductListResponse getProductById(Long id) {
        ClassRoom student = studentRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Item not found"));
        return createProductResponse(student);
    }

    private ProductListResponse createProductResponse(ClassRoom student) {
